...
(symbol('SPY'), symbol('VOO'))]
    ...
    context.stocks = symbols('SPY','IVV','IWB','FEZ','VOO')
    ...
    for i in range(context.num_pairs):
        ...
        if context.spread.shape[1] > context.z_window:
            ...
            if zscore > 1.0 and (not context.inShort[i]):
                ...
                context.target_weights[stock_y] = y_target_pct * (1 / context.num_pairs)
                context.target_weights[stock_x] = x_target_pct * (1 / context.num_pairs)
